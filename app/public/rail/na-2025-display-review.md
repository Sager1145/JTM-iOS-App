...
Generated 2026-09-10 by `app/scripts/railway/review-na-display.mjs` from the continuous-stroke model both clients draw (rail-network.js + rail-stroke.js). One row per published line; the flags are where a reviewer looks, not verdicts.

...
AMTRAK = {
    ...
    'California Zephyr': 'amtrak-ntad-california-zephyr',
    'Cardinal': 'amtrak-ntad-cardinal',
    'Capitol Corridor': 'amtrak-ntad-capitol-corridor',
    'City Of New Orleans': 'amtrak-ntad-city-of-new-orleans',
    'Coast Starlight': 'amtrak-ntad-coast-starlight',
    'Crescent': 'amtrak-ntad-crescent',
    'Downeaster': 'amtrak-ntad-downeaster',
    'Empire Builder': 'amtrak-ntad-empire-builder',
    'Illini': 'amtrak-ntad-illini',
    'Maple Leaf': 'amtrak-ntad-maple-leaf',
    'Northeast Regional': 'amtrak-ntad-northeast-regional',
    'Pacific Surfliner': 'amtrak-ntad-pacific-surfliner',
    'Saluki': 'amtrak-ntad-saluki',
    'Silver Meteor': 'amtrak-ntad-silver-meteor',
    'Keystone Service': 'amtrak-ntad-keystone-service',

...
- **The current absolute-or-share self-overlap gate reports 13 review candidates**, not 13 proven defects: 磐越西線; four VIA lines; Amtrak Downeaster and Ethan Allen Express; Galveston, Atlanta Streetcar, SunTran 790, Portland Streetcar NS, LIRR Port Washington and RTD E. Only Atlanta's extra lap is confirmed by `INTERVAL_RETRACES_LINE`; every other candidate still needs topology and source triage. Regenerate this ledger from JSON after package or threshold changes instead of preserving the count as truth.
